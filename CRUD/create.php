...
if (isset($_POST['nome'])) {
    $nome = $_POST['nome'];
    $email = $_POST['email'];
    $sql = $pdo->prepare("INSERT INTO pay (nome, email)VALUES (:nome,:email)");
    ...
    } else if ($sql->execute(array($_POST['nome'], $_POST['email']))) {
    ...
    <div class="container">
        ...
        <form action="./create.php" method="POST">
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="age" value="<?php if (isset($_SESSION["name"])) {
                        echo $_SESSION["name"] . '"';
                    } else {
                        echo '" placeholder=""';
                    } ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="age" value="<?php if (isset($_SESSION["email"])) {
                        echo $_SESSION["email"] . '"';
                    } else {
                        echo '" placeholder=""';
                    } ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="age" value="<?php if (isset($_SESSION["phone"])) {
                        echo $_SESSION["phone"] . '"';
                    } else {
                        echo '" placeholder=""';
                    } ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="address" value="<?php if (isset($_SESSION["address"])) {
